...
public class UrlBasedGenerator extends Generator {

    private UrlQrCodeRequest request;
    ...
    public BufferedImage generateImage() throws WriterException {
        ...
        BitMatrix bitMatrix = barcodeWriter.encode(request.getUrl(), BarcodeFormat.QR_CODE, 200, 200,
                encodingHints);
